...
const project = document.querySelectorAll(".all_project_div") as NodeListOf<HTMLElement>;
...
const inputBg = document.querySelectorAll(".input_class") as NodeListOf<HTMLElement>;
...
const hiLine = document.querySelectorAll(".line_hi") as NodeListOf<HTMLElement>;
...
if(homeLeft && project && footerS && container && awesome && inputBg && chat && social && hiLine && submit && footerYear && dark){
  ...
  return (
   <div className="home_div" id="home">
          ...
          <div className="right_side">
            <div className="dark_mode_div"><i className="fa-solid fa-moon fa-flip darkMode" onClick={()=>dark_mode()}></i></div>
